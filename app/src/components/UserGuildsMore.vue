<template>
    <div>
      <span id="open-modal">Ver mas</span>
          ...
          <div class="container">
            ...
            <div class="buy_options">
              ...
              <div style="display: flex; flex-direction: column;">
                <span style="font-size:x-large; font-weight: bolder">Resumen de la Orden</span>
                <span style=" margin: 2px;">Tenis papprimo</span>
...
.condition_pop{
  ...
  height: 70px;
  margin-top: 25px;
  box-shadow: rgb(104, 255, 174) 0px 5px 15px;
...
.buy_options{
  ...
  justify-content: space-between;
  margin: 10px;
  border-top: solid 1px rgb(94, 94, 94);
