        ...
        <div class="joint">
          ...
          <div class="second">
            ...
            <input
              ...
              v-if="route.params.typeuser == 'Person'"
            />
            ...
            >
              <input
                style="width: 99%; margin: 1%; height: 95%"
                type="text"
                class="log"
                placeholder="pais"
              ...
              <input
                ...
                type="text"
                class="log"
                placeholder="direccion: Carrera xxx # xxx-xxx"
                v-model="data.adress"
              />
            </div>
          </div>
          ...
          <span
            v-if="validations.error1"
            style="color: blueviolet; margin: 1px"
          >
            Las contraseñas no coinciden
          </span>
          <span
            v-if="validations.error2"
            style="color: blueviolet; margin: 1px"
          >
            Digite un correo valído</span
          >
          <span v-if="validations.error3" style="color: blueviolet; margin: 1px"
            >La contraseña debe tener al menos 8 caracteres</span
          >
          <span v-if="validations.error4" style="color: blueviolet; margin: 1px"
            >este correo o celular ya tienen cuenta asociada</span
          >
          <span v-if="validations.cargando" style="color: green; margin: 1px"
            >Cargando...</span
          >
          <span
            v-if="validations.exito && route.params.typeuser == 'Person'"
            style="color: green; margin: 1px"
            >Usuario creado, revisa tu correo para activarlo</span
          >
          <span
            v-if="validations.exito && route.params.typeuser == 'Store'"
            style="color: green; margin: 1px"
          ...
          <div>
            <p class="textblue">
              ...
              <strong @click="login" style="text-decoration: underline"
                >Ingresa aquí</strong
              >
            </p>
          </div>
  ...
  try {
    if (data.password != data.password2) {
      ...
      if (route.params.typeuser.toString() == "Person") {
        ...
        if (
          resp !==
          "Este_usuario_ya_esta_registrado-code:4556787651983640386377635"
        ) {
